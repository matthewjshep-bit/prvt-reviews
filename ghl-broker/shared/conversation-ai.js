...
export const INTENT_GLOSS = {
  agent: {
    ...
    address_chase: "when they said a property is coming but gave no address (\"I'll likely have one in Spanaway soon\"): checks in on it on days 2, 5, 9, 14, 21 and 30 until the address comes",
