...
export const OUTBOUND_INTENTS = {
  agent: ["outreach_open", "realm_check", "take_check", "offer_nudge", "passed_checkin", "outreach_nudge", "call_followup", "promise_due", "price_drop", "checkin_due"],
...
export const INTENT_LABEL = {
  agent: {
    ...
    call_followup: "text after a call", promise_due: "kept our word on a number we owed", price_drop: "saw the list price come down", checkin_due: "the check-in they asked for",
