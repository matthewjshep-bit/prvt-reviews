...
const targets = [
  ...
  { dir: path.join(root, "ghl-broker", "shared"), files: ["offer-calc.js", "offer-status.js", "offer-breakdown.js", "rehab-catalog.js", "us-address.js", "contract-template.js", "comp-match.js", "buybox.js"] },
];
